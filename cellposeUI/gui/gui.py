...
from qtpy.QtWidgets import QScrollArea, QMainWindow, QApplication, QStyle, QStyleFactory, QWidget, QScrollBar, QComboBox, QGridLayout, QPushButton, QFrame, QCheckBox, QLabel, QProgressBar, QLineEdit, QMessageBox, QGroupBox
...
class MainW(QMainWindow):
    ...
    def call_init(self):
        ...
        self.setPalette(guiparts.DarkPalette())
        self.setStyleSheet(guiparts.stylesheet())

        self.setStyleSheet(
            """
            QMainWindow {
                    background-color: rgb(63, 71, 68);
                    color: black;
            }
            """
        )
