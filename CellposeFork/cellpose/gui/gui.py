...
class MainW(QMainWindow):
    ...
    def __init__(self, image=None, logger=None):
        ...
        self.scrollareaPipeline.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOn)
        self.scrollareaPipeline.setStyleSheet("""QScrollArea { border: none }""")
        ...
        self.switchViewBtn.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
